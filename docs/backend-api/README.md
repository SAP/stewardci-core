...
| `spec.timeout` | (string,optional) The timeout value specified for a steward pipeline run in duration string format of composed of whole numbers, each with a unit suffix, such as "300m", "15h" or "2h45m". Valid time units are "s", "m" and "h". |
