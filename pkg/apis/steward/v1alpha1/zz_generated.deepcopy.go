...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JFRSpec) DeepCopyInto(out *JFRSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JFRSpec.
func (in *JFRSpec) DeepCopy() *JFRSpec {
	if in == nil {
		return nil
	}
	out := new(JFRSpec)
