...
// NewForConfigAndClient creates a new StewardV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*StewardV1alpha1Client, error) {
	...
	return &StewardV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new StewardV1alpha1Client for the given config and
...
func New(c rest.Interface) *StewardV1alpha1Client {
	return &StewardV1alpha1Client{c}
}
