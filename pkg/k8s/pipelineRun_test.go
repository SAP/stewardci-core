...
func Test_pipelineRun_changeStatusAndUpdateSafely_SetsUpdateResult_IfNoConflict(t *testing.T) {
	...
	// EXCERCISE
	examinee.changeStateAndStoreForRetry(changeFunc)
	resultErr := examinee.Commit()
...
func Test_pipelineRun_changeStatusAndUpdateSafely_NoUpdateOnChangeErrorInFirstAttempt(t *testing.T) {
	...
	// EXCERCISE
	resultErr := examinee.changeStateAndStoreForRetry(changeFunc)
...
func Test_pipelineRun_Commit_PanicsIfNoClientFactory(t *testing.T) {
	...
	examinee2.changeStateAndStoreForRetry(func() error { /* foo */ return nil })
