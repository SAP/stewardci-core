...
// GetTaskRunName mocks base method.
func (m *MockPipelineRun) GetTaskRunName() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTaskRunName")
	ret0, _ := ret[0].(string)
	return ret0
}

// GetTaskRunName indicates an expected call of GetTaskRunName.
func (mr *MockPipelineRunMockRecorder) GetTaskRunName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTaskRunName", reflect.TypeOf((*MockPipelineRun)(nil).GetTaskRunName))
}
...
// UpdateTaskRunName mocks base method.
func (m *MockPipelineRun) UpdateTaskRunName(arg0 string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "UpdateTaskRunName", arg0)
}

// UpdateTaskRunName indicates an expected call of UpdateTaskRunName.
func (mr *MockPipelineRunMockRecorder) UpdateTaskRunName(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTaskRunName", reflect.TypeOf((*MockPipelineRun)(nil).UpdateTaskRunName), arg0)
}
