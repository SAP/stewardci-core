...
// Source: github.com/SAP/stewardci-core/pkg/k8s (interfaces: ClientFactory,NamespaceManager,PipelineRun,PipelineRunFetcher,TenantFetcher,ServiceAccountTokenSecretRetriever)
...
// MockServiceAccountTokenSecretRetriever is a mock of ServiceAccountTokenSecretRetriever interface
type MockServiceAccountTokenSecretRetriever struct {
	ctrl     *gomock.Controller
	recorder *MockServiceAccountTokenSecretRetrieverMockRecorder
}

// MockServiceAccountTokenSecretRetrieverMockRecorder is the mock recorder for MockServiceAccountTokenSecretRetriever
type MockServiceAccountTokenSecretRetrieverMockRecorder struct {
	mock *MockServiceAccountTokenSecretRetriever
}

// NewMockServiceAccountTokenSecretRetriever creates a new mock instance
func NewMockServiceAccountTokenSecretRetriever(ctrl *gomock.Controller) *MockServiceAccountTokenSecretRetriever {
	mock := &MockServiceAccountTokenSecretRetriever{ctrl: ctrl}
	mock.recorder = &MockServiceAccountTokenSecretRetrieverMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockServiceAccountTokenSecretRetriever) EXPECT() *MockServiceAccountTokenSecretRetrieverMockRecorder {
	return m.recorder
}

// ForName mocks base method
func (m *MockServiceAccountTokenSecretRetriever) ForName(arg0 context.Context, arg1, arg2 string) (*v1.Secret, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForName", arg0, arg1, arg2)
...
func (mr *MockServiceAccountTokenSecretRetrieverMockRecorder) ForName(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForName", reflect.TypeOf((*MockServiceAccountTokenSecretRetriever)(nil).ForName), arg0, arg1, arg2)
}

// ForObj mocks base method
func (m *MockServiceAccountTokenSecretRetriever) ForObj(arg0 context.Context, arg1 *v1.ServiceAccount) (*v1.Secret, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForObj", arg0, arg1)
	ret0, _ := ret[0].(*v1.Secret)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ForObj indicates an expected call of ForObj
func (mr *MockServiceAccountTokenSecretRetrieverMockRecorder) ForObj(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForObj", reflect.TypeOf((*MockServiceAccountTokenSecretRetriever)(nil).ForObj), arg0, arg1)
}
